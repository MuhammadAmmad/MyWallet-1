 ...
 *
 *  This class displays a list of all categories are
...
public class Category extends AppCompatActivity implements Constants{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentClass = getIntent().getExtras().getString("className").toLowerCase();
                ...
                alert.setPositiveButton("Сохранить", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(changeCatName.length() > 0) {
                            ...
                            if(parentClass.equals("consumptionmoney")) {
                                eventColumnName = DatabaseHelper.CATEGORY_SPEND_COLUMN;
                            } else if (parentClass.equals("incomemoney")){
                                eventColumnName = DatabaseHelper.CATEGORY_INCOME_COLUMN;
                            }

                            newCatValue.put(eventColumnName, changeCatName);

                            SQLiteDatabase db = databaseHelper.getWritableDatabase();
                            db.update(DatabaseHelper.DATABASE_TABLE_WALLET,
                                    newCatValue, eventColumnName + " =? ", new String[]{oldNameCategory});
