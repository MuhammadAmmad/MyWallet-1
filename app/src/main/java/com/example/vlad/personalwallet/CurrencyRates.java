...
public class CurrencyRates extends AppCompatActivity {
    ...
    /**
     * Calls, in a separate thread, the method to obtain the exchange
     * rate online, and set visible a progress bar
     */
    ...
    /**
     * By clicking on the button "equals", method collects the data
    ...
    /**
     * Transfer result to the previous activity
     */
    ...
    /**
     * Class for action in a separate thread
     */
    private class MyTask extends AsyncTask<String, Void, String> {
        ...
        /**
         * Makes request to the server, and result is entered in string
         *
         * @param path - address to api
